...
export const VALID_RECOVERY_TRANSITIONS: Record<RecoveryStatus, RecoveryStatus[]> = {
  OPEN: ['ANALYZING', 'DETECTED', 'READY', 'EXECUTING', 'CLOSED'],
  DETECTED: ['ANALYZING', 'OPEN', 'DIAGNOSED', 'READY', 'CLOSED'],
  ANALYZING: ['READY', 'DIAGNOSED', 'ELIGIBLE', 'ESCALATED', 'BLOCKED', 'NEEDS_REVIEW'],
  ...
  EXECUTING: ['RECOVERED', 'FAILED', 'ESCALATED', 'BLOCKED', 'NEEDS_REVIEW'],
  RECOVERED: ['CLOSED'],
  FAILED: ['READY', 'EXECUTING', 'ESCALATED', 'CLOSED', 'NEEDS_REVIEW'],
  BLOCKED: ['CLOSED', 'ESCALATED', 'READY'],
  ESCALATED: ['READY', 'EXECUTING', 'CLOSED', 'BLOCKED', 'APPROVED'],
  NEEDS_REVIEW: ['READY', 'EXECUTING', 'CLOSED', 'BLOCKED', 'ESCALATED', 'APPROVED'],
  CLOSED: [],
};
